...
class SurveyController extends Controller
{
  ...
  public function guest(Request $request, $token)
  {
    ...
    $newData = [
      $this->guestRates['event_hear'] => $validated['event_hear'],
      $this->guestRates['guest_rate_1'] => $validated['guest-rate-1'],
      $this->guestRates['guest_rate_2'] => $validated['guest-rate-2'],
      $this->guestRates['guest_rate_3'] => $validated['guest-rate-3'],
      $this->guestRates['guest_rate_4'] => $validated['guest-rate-4'],
      $this->guestRates['guest_rate_5'] => $validated['guest-rate-5'],
      $this->guestRates['guest_rate_6'] => $validated['guest-rate-6'],
      $this->guestRates['guest_rate_7'] => $validated['guest-rate-7'],
      $this->guestRates['guest_rate_8'] => $validated['guest-rate-8'],
      $this->guestRates['guest_rate_9'] => $validated['guest-rate-9'],
      $this->guestRates['guest_rate_10'] => $validated['guest-rate-10'],
      $this->guestRates['notes'] => $validated['notes'],
    ];
  ...
  public function speaker(Request $request, $token)
  {
    ...
    $newData = [
      $this->speakerRates['attend_count'] => $validated['attend_count'],
      $this->speakerRates['speaker_rate_1'] => $validated['speaker-rate-1'],
      $this->speakerRates['speaker_rate_2'] => $validated['speaker-rate-2'],
      $this->speakerRates['speaker_rate_3'] => $validated['speaker-rate-3'],
      $this->speakerRates['speaker_rate_4'] => $validated['speaker-rate-4'],
      $this->speakerRates['notes'] => $validated['speaker-rate-4']
    ];
