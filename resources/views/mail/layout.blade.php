...
<body>
	<div style="padding:25px 10px;width:calc(100% - 20px);background-color: #062E3A;text-align: center;border-radius: 6px;">
		<a href="{{ url('/') }}"><img style="max-height: 77px;" src="{{asset('img/logoDark.png')}}" alt="logo"></a>
